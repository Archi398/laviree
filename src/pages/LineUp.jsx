...
export default function LineUp() {
  ...
  return (
    <div className={styles.container} style={nb_artistes !== 0 ? { height: '3000px' } : {}}>
      <div className={styles.allContainer} ref={allContainerRef}>
        <div className={styles.allContainerSticky}>
          ...
          <div className={styles.cardContainer} ref={cardContainerRef} style={nb_artistes !== 0 ? { height: '70vh' } : {}}>
            <PinkCard
              type="lineUp"
              title="Line-up"
